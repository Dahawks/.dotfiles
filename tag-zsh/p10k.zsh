# Generated by Powerlevel10k configuration wizard on 2020-04-28 at 11:16 CST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 64300.
# Wizard options: nerdfont-complete + powerline, small icons, classic, unicode, dark,
# 24h time, slanted separators, blurred heads, round tails, 2 lines, disconnected,
# compact, many icons, fluent, transient_prompt, instant_prompt=off.
